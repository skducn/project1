...
if __name__ == '__main__':
	...
	api_body = {'imei': '123123', 'userName': 'shuyang', 'password': '07497ba923378ceada4a7f6428be9956'}
	api_header = {"Content-Type": "application/x-www-form-urlencoded"}
	response = tb.post_request_multipart("http://192.168.0.36:8080/app/login", api_body, api_header, "file", api_body["file"])
	print(response)
