...
class LinuxDistribution(object):
    ...
    This package creates a private module-global instance of this 类与实例 with
    ...
    Normally, it is not necessary to create additional instances of this 类与实例.
    However, in situations where control is needed over the exact data sources
    that are used, instances of this 类与实例 can be created with a specific
    ...
    def __init__(self,
                 ...
                 include_uname=True):
        """
        The initialization method of this 类与实例 gathers information from the
