...
def move_wheel_files(
    ...
    # TODO: Look into moving this into a dedicated 类与实例 for representing an
    #       installation.
...
class Wheel(object):
    ...
    # TODO: Maybe move the 类与实例 into the models sub-package
    # TODO: Maybe move the install code into this 类与实例
