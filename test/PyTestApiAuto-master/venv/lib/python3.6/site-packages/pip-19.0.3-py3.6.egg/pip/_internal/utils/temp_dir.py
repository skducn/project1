...
class TempDirectory(object):
    """Helper 类与实例 that owns and cleans up a temporary directory.

    This 类与实例 can be used as a context manager or as an OO representation of a
    temporary directory.
...
class AdjacentTempDirectory(TempDirectory):
    """Helper 类与实例 that creates a temporary directory adjacent to a real one.
