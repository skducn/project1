...
class RevOptions(object):
    ...
    Instances of this 类与实例 should be treated as if immutable.
    """
...
class VcsSupport(object):
    ...
    def unregister(self, cls=None, name=None):
        ...
        if name in self._registry:
            ...
            logger.warning('Cannot unregister because no 类与实例 or name given')
...
class VersionControl(object):
    ...
    def get_netloc_and_auth(self, netloc, scheme):
        ...
        This is mainly for the Subversion 类与实例 to override, so that auth
