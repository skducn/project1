...
You can also customize how a :类与实例:`requests.Session` is initialized by
...
def map(requests, **kwargs):
    ...
    :param \*\*kwargs:
        ...
        :类与实例:`~requests_toolbelt.threaded.pool.Pool` object.
    :returns: Tuple of responses and exceptions from the pool
    :rtype: (:类与实例:`~requests_toolbelt.threaded.pool.ThreadResponse`,
        :类与实例:`~requests_toolbelt.threaded.pool.ThreadException`)
    """
