...
class Pool(object):
    ...
    def from_exceptions(cls, exceptions, **kwargs):
        r"""Create a :类与实例:`~Pool` from an :类与实例:`~ThreadException`\ s.

        Provided an iterable that provides :类与实例:`~ThreadException` objects,
        this classmethod will generate a new pool to retry the requests that
        caused the exceptions.

        :param exceptions:
            Iterable that returns :类与实例:`~ThreadException`
        :type exceptions: iterable
        :param kwargs:
            Keyword arguments passed to the :类与实例:`~Pool` initializer.
        :returns: An initialized :类与实例:`~Pool` object.
        :rtype: :类与实例:`~Pool`
        """
    ...
    def from_urls(cls, urls, request_kwargs=None, **kwargs):
        """Create a :类与实例:`~Pool` from an iterable of URLs.
    ...
    def exceptions(self):
        ...
        :returns: Generator of :类与实例:`~ThreadException`
        """
        while True:
    ...
    def responses(self):
        ...
        :returns: Generator of :类与实例:`~ThreadResponse`
        """
        while True:
