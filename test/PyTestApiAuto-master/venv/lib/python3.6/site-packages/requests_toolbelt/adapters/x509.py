...
class X509Adapter(HTTPAdapter):
    ...
    interface. This 类与实例 will need to be manually instantiated and mounted
    to the session
    ...
    :param max_retries: The maximum number of retries each connection
        ...
        ``Retry`` 类与实例 and pass that instead.
    ...
    :type encoding:
        :类与实例: `cryptography.hazmat.primitives.serialization.Encoding`
