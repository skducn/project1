...
This holds the implementation details for the :类与实例:`StreamingIterator`. It
is designed for the case where you, the user, know the size of the upload but
need to provide the data as an iterator. This 类与实例 will allow you to specify
...
class StreamingIterator(object):
    ...
    """
    This 类与实例 provides a way of allowing iterators with a known size to be
    ...
    these details you can instead just use this 类与实例. You simply provide the
    ...
    You can also pass file-like objects to :py:类与实例:`StreamingIterator` in
