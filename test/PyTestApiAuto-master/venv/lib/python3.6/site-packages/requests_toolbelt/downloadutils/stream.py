...
def get_download_file_path(response, path):
    ...
    :rtype: str
    :raises: :类与实例:`requests_toolbelt.exceptions.StreamingError`
    """
...
def stream_response_to_file(response, path=None, chunksize=_DEFAULT_CHUNKSIZE):
    ...
    provide either a :类与实例:`io.BytesIO` object or a file opened with the
    ...
    :type path: :类与实例:`str`, or object with a :meth:`write`
