...
class StdCaptureFD(Capture):
    """ This 类与实例 allows to capture writes to FD1 and FD2
...
class StdCapture(Capture):
    """ This 类与实例 allows to capture writes to sys.stdout|stderr "in-memory"
...
class DontReadFromInput:
    """Temporary stub 类与实例.  Ideally when stdin is accessed, the
