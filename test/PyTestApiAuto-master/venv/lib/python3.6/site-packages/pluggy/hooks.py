...
class HookspecMarker(object):
    """ Decorator helper 类与实例 for marking functions as hook specifications.
...
class HookimplMarker(object):
    """ Decorator helper 类与实例 for marking functions as hook implementations.
...
def varnames(func):
    ...
    method, 类与实例 or callable.

    In case of a 类与实例, its ``__init__`` method is considered.
