...
class AllureTestListener(object):
    ...
    def start_step(self, name):
        """
        Starts an new :py:类与实例:`allure.structure.TestStep` with given ``name``,
    ...
    def _fill_case(self, report, call, pyteststatus, status):
        ...
        :param status: a :py:类与实例:`allure.constants.Status` entry
        """
...
class AllureAgregatingListener(object):
    ...
    def write_attach(self, attachment):
        ...
        :param attachment: a :py:类与实例:`allure.structure.Attach` object
        """
