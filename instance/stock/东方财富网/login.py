...
def login_eastmoney(web_po_instance, varUrl):
    """
    东方财富网登录流程封装
    :param web_po_instance: WebPO实例
    """
    web_po_instance.openURL(varUrl)
...
def create_logged_web_instance(browser_type="chrome", varUrl="https://quote.eastmoney.com/zixuan/lite.html"):
    """
    创建并返回已登录的WebPO实例
