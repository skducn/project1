...
def main(d_url):
    ...
    for k, v in d_url.items():
        ...
        for j in range(1, int(varPage) + 1):
            ...
            l_data = xxx(l_data, ['000997','002186','002095','002183','002264','002209','002029','000735','002136'])
            ...
            for l_data in l_l_data:
                try:
                    ...
                    if l_data_7 > 15:
                        ...
                    elif (l_data_7 > 3 and l_data_7 <= 15) :
                        if int(l_data[1]) < 688000 and (float(l_data[6]) > 10 and float(l_data[6]) <= 60) and \
