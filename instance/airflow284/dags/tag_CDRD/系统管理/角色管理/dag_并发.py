        ...
        if l_col_values_list:
            for l_col_values in l_col_values_list:
                ...
                if (isinstance(l_col_values[1], str) and
                    ...
                    submodule_name = l_col_values[2]  # "并发管理"
                    ...
                    # 方法1: 直接执行脚本文件
                    full_path = f"/Users/linghuchong/Downloads/51/Python/project/instance/zyjk/CDRD/web/{module_name}/{submodule_name}/{script_name}"
