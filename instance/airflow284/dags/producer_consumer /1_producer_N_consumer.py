...
def consumer_1_N_read_clean_order_data(**context):
    ...
    xcom_value = get_producer_xcom("producer_1_N_sync", "producer_1_N_save_data")
...
with DAG(
    ...
    clean_task = PythonOperator(
        ...
        op_kwargs={"producer_dag_id": "producer_1_N_sync", "producer_task_id": "producer_1_N_save_data"}
    )
