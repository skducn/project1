...
if __name__ == "__main__":
    ...
    # 将上面的xxx修改为自己实际的爬虫名
    # 查看运行命令 python p_main.py --help
    # AirSpider与Spider爬虫运行方式 python p_main.py --crawl_xxx
    # BatchSpider运行方式
    # 1. 下发任务：python p_main.py --crawl_xxx 1
    # 2. 采集：python p_main.py --crawl_xxx 2
    # 3. 重置任务：python p_main.py --crawl_xxx 3
