...
# 如果没有参数，默认test环境
if len(argvParam) == 0 :
    print("实例1: 测试结束后发邮件, python runbycmd.py email")
    print("实例2: 测试结束后打开报表, python runbycmd.py rpt")
    print("实例3: 先拉取项目，测试结束后打开报表和发邮件, python runbycmd.py all")
    print("实例4: 先拉取项目，测试结束后打开报表, python runbycmd.py pull_rpt")
    print("实例5: 先拉取项目，测试结束后发邮件, python runbycmd.py pull_email")
    sys.exit(0)
    ...
    if argvParam[0] == "email":
        ...
        sendEmail = "off"
        updateProject = "on"
    elif argvParam[0] in "pull_rpt":
        openRpt = "on"
        sendEmail = "off"
        updateProject = "on"
    elif argvParam[0] in "pull_email":
        openRpt = "off"
        sendEmail = "on"
        updateProject = "on"
    else:
