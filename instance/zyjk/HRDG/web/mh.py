...
varUrl = 'http://200.200.200.14:9071'

# 2，医生登录
Hrdg_PO.login(varUrl + '/health/select', "chenliting", "Mh200443")
# Hrdg_PO.edtBasicInfo("310113198111283661")  # 唐瑾
Hrdg_PO.edtBasicInfo(varUrl, dd)  # 唐瑾
