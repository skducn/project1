...
# Author     : John
# Created on : 2025-2-7
# Description: 基本公卫 - 慢性组阻塞性肺病管理 - 慢阻肺病专项
# 动态调用函数1
...
# todo 1 查询
Gw_PO.phs_copd_project_query({"身份证号": "110101193901013599"})
...
# todo 2 详情
# Gw_PO.phs_copd_project_operation([{"身份证号": "110101193901013599"}, '详情'])
# Gw_PO.phs_copd_project_operation([{' 居住地址 ': ['上海市', '市辖区', '虹口区', '广中路街道', '商业一村居委会', '多媒体100号'],
#                                                ' 确诊日期 ': [2024, 7, 1],
...
# todo 3 随访
Gw_PO.phs_copd_project_operation([{"身份证号": "110101193901013599"}, '随访'])
Gw_PO.phs_copd_project_operation([{'随访日期': [2025, 2, 9], '随访方式': '网络', '症状': ['呼吸困难', {'其他': '123'}, '发热'],
