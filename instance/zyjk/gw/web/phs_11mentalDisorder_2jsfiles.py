...
# todo 2 导出(.xls)
# Gw_PO.export("/Users/linghuchong/Desktop/2jsfiles.xlsx")
...
Gw_PO.phs_memtalDisorder_jsfiles_operation({'operate': '访视记录之新增随访', 'data': {
    ' 随访日期 ': [2025,3,19], ' 本次随访形式 ': '家庭',
    ' 若失访，原因 ': {'其他': '123'}, ' 监护人电话 ': '13819181716',
    ' 如死亡 ': {' 死亡日期 ':[2025,3,1], ' 死亡原因 ':{'躯体疾病(':['肿瘤','脑血管病']},
    ' 危险性评估 ': '4级',
    ' 目前症状 ': {'其他':'444'}, '自知力 ': '自知力缺失',
    ' 睡眠情况 ': '一般', ' 饮食情况 ': '良好',
