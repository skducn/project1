...
#     '此次随访分类': {'高血脂患者': {'随访评价结果':'不良反应', '下一步管理措施': '紧急转诊','下次随访日期':[2025,1,5]}},
#     '用药调整情况': {'药品名称1':'不良反应', '用法用量': ['每日两次','1','2']},
...
# Gw_PO_three.three_ThreeHighs_ThnVisitList_operation({'operate': '编辑', 'data': {
