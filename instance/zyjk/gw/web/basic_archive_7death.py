...
# 1 查询
# Gw_PO.death_query({"姓名": "李秀琴", "身份证号": "410522200005110812", "死亡日期": [[2023, 5, 10], [2023, 5, 12]], "现住址": ["泉山街道", "花园区居委会", "123"]})
Gw_PO.death_query({"身份证号": "41052220000511081"})

# # 2 导出
Gw_PO.death_out("/Users/linghuchong/Desktop/17.xls")
