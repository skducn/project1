...
# todo 1 查询
# Gw_PO.phs_hypertension_gxyjob_query({"身份证号": "110101199003075678"})
...
# todo 2 导出(17.xls)
# Gw_PO.phs_hypertension_gxyjob_export("/Users/linghuchong/Desktop/1756")



# todo 3 详情 - 编辑（高血压随访记录）
Gw_PO.phs_hypertension_gxyjob_operation({'operate': '详情', 'option': {'随访日期': '2025-02-14'}})
Gw_PO.phs_hypertension_gxyjob_operation({'operate': '详情', 'index': {'随访日期': '2025-02-29', 'operate2': '编辑'},
                                         "value": {'随访日期': [2025, 2, 10], '随访方式': '网络', '症状': ['头痛头晕', {'其他': '123'}, '下肢水肿'],
...
# Gw_PO.phs_hypertension_gxyjob_operation({'operate': '编辑', 'option': {'随访日期': '2024-09-14'}})
# Gw_PO.phs_hypertension_gxyjob_operation({'operate': '编辑', 'index': {'随访日期': '2024-09-14', 'operate2': '编辑或新增'},
#                                          "value": {'随访日期': [2025, 2, 9], '随访方式': '网络', '症状': ['头痛头晕', {'其他': '123'}, '下肢水肿'],
#                                                '血压': [11, 12], '身高': '177', '体重': [66, 77], '心率':'100', '其他': "测试一下",
#                                                '日吸烟量':[11,14], '日饮酒量':[112,144],
#                                                '运动频率实际': '每天', '运动频率目标': '不运动',
#                                                '运动时长':[11, 23], '摄盐量分级实际': '轻', '摄盐量分级目标': '中', '随访饮食合理性评价': '合理', '心理调整评价结果': '差', '随访遵医行为': '一般',
...
# Gw_PO.phs_hypertension_gxyjob_query({"身份证号": "310101200006036356"})
# Gw_PO.phs_hypertension_gxyjob_operation({'operate': '编辑', 'option': {'随访日期': '2025-02-09'}})
# Gw_PO.phs_hypertension_gxyjob_operation({'operate': '编辑', 'index': {'operate2': '引入上次新增'},
#                                          "value": {'随访日期': [2025, 3, 9], '下次随访日期': [2025, 5, 9]}})
