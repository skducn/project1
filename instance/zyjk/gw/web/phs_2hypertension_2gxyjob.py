...
# todo 4 编辑
# Gw_PO.phs_hypertension_gxyjob_operation({'operate': '编辑', 'option': {'随访日期': '2025-02-14'}, 'index': {'随访日期': '2025-02-19'},
...
# todo 4-2 引用上次新增
# Gw_PO.phs_hypertension_gxyjob_operation({'operate': '编辑', 'option': {'随访日期': '2025-02-14'}, 'index': {'operate2': '引入上次新增'},
#                                          "value": {'随访日期': [2025, 2, 9], '下次随访日期': [2025, 5, 9]}})


# todo 4-3 新增
Gw_PO.phs_hypertension_gxyjob_operation({'operate': '编辑', 'option': {'随访日期': '2025-02-14'}, 'index': {'operate2': '新增'},
                                         "value": {'随访日期': [2025, 2, 9], '随访方式': '网络', '症状': ['头痛头晕', {'其他': '123'}, '下肢水肿'],
                                               '血压': [11, 12], '身高': '177', '体重': [66, 77], '心率':'100', '其他': "测试一下",
                                               '日吸烟量':[11,14], '日饮酒量':[112,144],
                                               '运动频率实际': '每天', '运动频率目标': '不运动',
...
# todo 5 删除
# Gw_PO.phs_hypertension_gxyjob_operation({'operate': '删除', 'option': {'随访日期': '2025-02-14'}})
