...
# 动态调用函数1
# s_func = 'phs_hbp_assessdata_query'
# getattr(Gw_PO, s_func)({"身份证号": "41052220000511081"})
# 动态调用函数2(有风险)
# s_func = 'Gw_PO.phs_hbp_assessdata_query({"身份证号": "41052220000511081"})'
# eval(s_func)
# *****************************************************************
from GwPO import *
...
# # todo 1 查询
# Gw_PO.phs_hbp_assessdata_query()
getattr(Gw_PO, s_func + '_query')({"身份证号": "340203202407017263"})
