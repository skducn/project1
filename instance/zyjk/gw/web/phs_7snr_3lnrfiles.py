...
Gw_PO.phs_snr_lnrfiles_operation({'operate': '新增体验', 'data': {
    ...
    '一般状况': {'体温':'37','脉率':'66','呼吸频率':'88','腰围':'90','右侧血压':['100','90'],'身高': '177', '体重': '66', '体质指数(BMI)': '100'},
    '老年人健康状态自我评估': '不满意', '老年人认知能力': '粗筛阳性', ' 老年人生活自理': '中度依赖(9~18分)','老年人情感状态':'粗筛阳性',
    '体育锻炼': '每天', '饮食习惯': ['荤食为主', '嗜油'], '吸烟情况': {'吸烟状况': '现在每天吸', '日吸烟量': '4', '开始吸烟年龄': '22', '戒烟年龄': '44'},
    '饮酒情况': {'饮酒评率': '每天', '是否戒酒': '其他'},
    '职业病危害': {'有':['2','4'], '毒物种类': {
        '粉尘': {'粉尘':'10', '防护措施': {'有':"1"}},
