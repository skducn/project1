...
# todo 1 查询
Gw_PO.phs_healthrecord_personal_query({"姓名": "丽丽"})
# Gw_PO.phs_healthrecord_personal_query({"身份证号": "372922198510281068"})
# getattr(Gw_PO, s_func + '_query')({"姓名": "胡成", "性别": "男", "身份证号": "110101194301191302", "出生日期范围": [[2025, 1, 1], [2025, 1, 2]],"人群分类": ["残疾人","孕产妇"], "档案是否开放": "否",
...
# todo 操作 - 查看
# Gw_PO.phs_healthrecord_personal_operation({'operate': ' 查看 ', 'option': {"身份证号": "372922198510281068"}})
# Gw_PO.phs_healthrecord_personal_operation({'operate': ' 查看 ', 'option': {"姓名": "李丽丽", "档案编号": "37068500000000047"}})



# todo 操作 - 更新
Gw_PO.phs_healthrecord_personal_operation({'operate': ' 更新 ', 'option': {"姓名": "李丽丽", "档案编号": "37068500000000047"}})
Gw_PO.phs_healthrecord_personal_operation({'operate': '仅保存', 'data': {
    ...
    # ' 与户主关系 ': '子', ' 户主姓名 ': "李四2", ' 户主身份证号 ': "310101198004110013", ' 家庭人口数 ': "4", ' 家庭结构 ': "3", ' 居住情况 ': '独居',
    # ' 厨房排风设施 ': '烟囱', ' 燃料类型 ': '煤', ' 饮水 ': '自来水', ' 厕所 ': '马桶', ' 禽畜栏 ': '无',
    # ' 管理机构 ': ["金岭镇卫生院", "金岭镇山上候家村卫生室"], ' 档案是否开放 ': "否", ' 建档日期 ': [2025, 1, 16],
    # ' 更新方式 ': '门诊',' 更新内容 ': "测试三峡",
    }})
