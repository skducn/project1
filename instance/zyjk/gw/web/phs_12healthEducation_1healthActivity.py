...
# 动态调用函数1
# s_func = 'phs_healtheducation_healthactivity_query'
# getattr(Gw_PO, s_func)({"身份证号": "41052220000511081"})
# 动态调用函数2(有风险)
# s_func = 'Gw_PO.phs_healtheducation_healthactivity_query({"身份证号": "41052220000511081"})'
# eval(s_func)
# *****************************************************************
from GwPO import *
...
varUrl = d_menu_basicPHS['健康教育活动']
s_func = varUrl.split('http://192.168.0.203:30080/')[1]
s_func = s_func.replace("/", "_")
s_func = s_func.lower()
# print(s_func)  # phs_healtheducation_healthactivity
Web_PO.opnLabel(d_menu_basicPHS['健康教育活动'])
Web_PO.swhLabel(1)



# todo 1 查询
# Gw_PO.phs_healtheducation_healthactivity_query()
getattr(Gw_PO, s_func + '_query')({"活动日期":[[2025,1,2], [2025,2,4]], "活动地点": "上海", "活动形式": "开展咨询活动", "活动主题": "普法宣传", "主讲人": "阿依达"})


# todo 2 新增
# Gw_PO.phs_healtheducation_healthactivity_new()
getattr(Gw_PO, s_func + '_new')({
