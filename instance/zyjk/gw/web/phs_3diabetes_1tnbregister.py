...
# todo 2 导出(.xls)
# Gw_PO.phs_diabetes_tnbregister_export("/Users/linghuchong/Desktop/333")



# todo 3 详情
Gw_PO.phs_diabetes_tnbregister_operation([{'建卡日期': '2024-07-15', '年龄': "1"}, '详情'])
# Gw_PO.phs_diabetes_tnbregister_operation([{' 居住地址 ': ['上海市', '市辖区', '虹口区', '广中路街道', '商业一村居委会', '多媒体100号'],
#                                            ' 确诊日期 ': [2024, 2, 2], ' 是否终止管理 ': '否',
#                                            '建卡时间': [2025, 2, 2], '建卡医生': "卫生院"
#                                             }, '详情编辑'])
# Gw_PO.phs_diabetes_tnbregister_operation([{' 居住地址 ': ['上海市', '市辖区', '虹口区', '广中路街道', '商业一村居委会', '多媒体100号'],
#                                                ' 确诊日期 ': [2024, 7, 1],
#                                                ' 是否终止管理 ': '是', '终止管理日期': [1900, 2, 5], '终止管理原因': "nono",
#                                                '建卡时间': [2025, 2, 2], '建卡医生': "卫生院"}, '详情编辑'])



# todo 4 评估
# Gw_PO.phs_diabetes_tnbregister_operation([{'建卡日期': '2024-07-15', '年龄': "1"}, '评估'])
# Gw_PO.phs_diabetes_tnbregister_operation([{' 空腹血糖 ': '理想', ' 餐后血糖 ': "良好", ' 糖化血红蛋白 ': '差', ' 血压评价 ': '差',
...
# todo 5 随访
# Gw_PO.phs_diabetes_tnbregister_operation([{'建卡日期': '2025-02-02', '年龄': "1"}, '随访'])
# Gw_PO.phs_diabetes_tnbregister_operation([{'随访日期': [2025, 2, 9], '随访方式': '网络', '症状': ['头痛头晕', {'其他': '123'}, '下肢水肿'],
...
#                                                '下次随访日期': [2025, 2, 9], '随访医生':'测试1', '居民签字': '张三丰'}, '随访新增'])


# Gw_PO.phs_diabetes_tnbregister_operation(['', '随访点击新增'])
#
# Gw_PO.phs_diabetes_tnbregister_operation([{'随访日期': [2025, 2, 9], '随访方式': '网络', '症状': ['头痛头晕', {'其他': '123'}, '下肢水肿'],
#                                                '血压': [11, 12], '身高': '177', '体重': [66, 77], '足背动脉搏动':'未检测', '其他': "测试一下",
#                                                '日吸烟量':[11,14], '日饮酒量':[112,144],
