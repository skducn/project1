...
# Gw_PO.phs_diabetes_tnbregister_operation({'operate': '详情', 'index': {'operate2': '编辑'},
...
# Gw_PO.phs_diabetes_tnbregister_operation({'operate': '评估', 'index': {'operate2': '新增'},
#                                                'value': {' 空腹血糖 ': '理想', ' 餐后血糖 ': "良好", ' 糖化血红蛋白 ': '差', ' 血压评价 ': '差',
...
Gw_PO.phs_diabetes_tnbregister_operation({'operate': '随访', 'index': {'operate2': '引入上次新增'},
