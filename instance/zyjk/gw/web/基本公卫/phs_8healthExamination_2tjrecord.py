...
Web_PO.opnLabel(d_menu_basicPHS['体检记录'])
Web_PO.swhLabel(1)


# todo 1 查询
Gw_PO.phs_healthExamination_tjrecord_query({'姓名': 'szz'})
# Gw_PO.phs_healthExamination_tjrecord_query({"管理机构": "招远市卫健局", '是否仅查询机构': '是', "档案状态": "在档", "姓名": "胡成", '出生日期': [[2025,1,1],[2025,2,2]]})


# todo 2 导出
# Gw_PO.export("/Users/linghuchong/Desktop/phs_healthExamination_tjrecord.xls")


# todo 3 操作 - 详情
# Gw_PO.phs_healthExamination_tjrecord_operation({'operate': '详情', 'option': {"身份证号": "341226199708114773", '体检医生': '1'}})


# # todo 4 操作 - 编辑
# Gw_PO.phs_healthExamination_tjrecord_operation({'operate': '编辑', 'option': {"身份证号": "341226199708114773", '体检医生': '1'}})
# Gw_PO.phs_healthExamination_tjrecord_operation({'operate': '编辑', 'data': {
...
# # todo 4 操作 - 删除
Gw_PO.phs_healthExamination_tjrecord_operation({'operate': '删除', 'option': {"身份证号": "341226199708114773", '体检医生': '1'}})