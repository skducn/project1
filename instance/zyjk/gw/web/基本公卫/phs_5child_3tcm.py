...
# Description: 基本公卫 - 儿童健康管理 - 中医体质辨识列表
# *****************************************************************
import sys,os
# 获取当前文件的绝对路径
...
Web_PO.opnLabel(d_menu_basicPHS['中医体质辨识列表'])
Web_PO.swhLabel(1)


# todo 1 查询
# Gw_PO.phs_child_tcm_query({"儿童管理机构": "招远市卫健局", "是否仅查询机构": "是", "姓名": "胡成", "身份证号": "110101199001015000",
#                            "出生日期": [[2025, 1, 1], [2025, 1, 2]], "随访日期": [[2025, 1, 3], [2025, 1, 5]], "检查类型": "3岁",
#                            "管理状态": "管理中", "管理类型": "本地管理",
#                            "家庭地址": ["大秦家街道", "大秦家村民委员会", "123"], "随访医生": "张三"})


# todo 2 导出
# Gw_PO.export("/Users/linghuchong/Desktop/phs_child_tcm.xls")



# todo 3 编辑
# Gw_PO.phs_child_tcm_query({"身份证号": "110101202401015310"})
# Gw_PO.phs_child_tcm_operation({'operate': '编辑', 'option': {"身份证号": "110101202401015310"}})
# Gw_PO.phs_child_tcm_operation({'operate': '编辑', 'option': {"身份证号": "110101202401015310", '检查类型': '12月龄'}})

# # todo 4.1 新生儿家庭访视记录表
# Gw_PO.phs_child_tcm_operation({'operate': '编辑', 'title': '新生儿家庭访视记录表', 'data': {
#     '新生儿': {
