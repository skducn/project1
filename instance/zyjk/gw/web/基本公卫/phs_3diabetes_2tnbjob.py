...
# todo 2 导出
# Gw_PO.export("/Users/linghuchong/Desktop/phs_diabetes_tnbjob.xlsx")
...
# Gw_PO.phs_diabetes_tnbjob_operation({'operate': '详情', 'operate2': '编辑', "data": {
#     '随访日期': [2025, 2, 11], '随访方式': '网络', '症状': ['头痛头晕', {'其他': '123'}, '下肢水肿'],
...
# Gw_PO.phs_diabetes_tnbjob_operation({'operate': '编辑', 'operate2': '新增', "data": {
#     '随访日期': [2025, 2, 13], '随访方式': '网络', '症状': ['头痛头晕', {'其他': '123'}, '下肢水肿'],
#     '血压': [11, 12], '身高': '177', '体重': [66, 77], '足背动脉搏动':'未检测', '其他': "测试一下",
#     '日吸烟量':[11,14], '日饮酒量':[112,144],
#     '运动频率实际': '每天', '运动频率目标': '不运动',
#     '运动时长':[11, 23],
...
# # Gw_PO.phs_diabetes_tnbjob_query({"身份证号": "370685202402190640"})
# Gw_PO.phs_diabetes_tnbjob_operation({'operate': '编辑', 'option': {'随访日期': '2025-02-09'}})
# Gw_PO.phs_diabetes_tnbjob_operation({'operate': '编辑', 'operate2': '引入上次新增', "data": {'随访日期': [2025, 3, 9], '下次随访日期': [2025, 5, 9]}})
...
# todo 6 姓名 (更新)
Gw_PO.phs_diabetes_tnbjob_operation({'operate': '姓名', 'option': {'随访日期': '2025-02-09'}})
Gw_PO.phs_diabetes_tnbjob_operation({'operate': '姓名', 'operate2': '更新', 'data': {
...
# todo 6 姓名（获取）
# Gw_PO.phs_diabetes_tnbjob_operation({'operate': '姓名', 'option': {'随访日期': '2025-02-09'}})
# d_ = Gw_PO.phs_diabetes_tnbjob_operation({'operate': '姓名', 'operate2': '获取', 'data': {}})
