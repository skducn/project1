...
# Description: 基本公卫 - 老年人健康管理 - 本年度未体检
# *****************************************************************
import sys,os
# 获取当前文件的绝对路径
...
Web_PO.opnLabel(d_menu_basicPHS['本年度未体检'])
Web_PO.swhLabel(1)


# todo 1 查询
Gw_PO.phs_snr_unexamined_query({"姓名": "1"})
# Gw_PO.phs_snr_unexamined_query({"管理机构": "招远市卫健局", '是否仅查询机构': '是', "姓名": "胡成", "身份证号": "370685193905042226",
#     "现住址": ["泉山街道", "花园社区居民委员会", "123"], "档案状态": "在档"})


# todo 2 导出
# Gw_PO.export("/Users/linghuchong/Desktop/phs_snr_unexamined.xls")



# todo 3 操作 - 新增
Gw_PO.phs_snr_unexamined_operation({'operate': '新增', 'option': {"身份证号": "340203195002048018"}})
Gw_PO.phs_snr_unexamined_operation({'operate': '新增', 'data': {
