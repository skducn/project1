...
# 	" 常住类型 ": "非户籍"}
# df = pd.DataFrame(d_)
# df.to_excel('output.xlsx', index=False)  # 以上字典转换成表格后，有3行记录，因为 ["听力残疾", "精神残疾", ["其他残疾", "56789"]]或[2025, 10, 16]会被拆分成3行

# # 表格转换字典
# d_ = Pandas_PO.xlsx2dict("output.xlsx", "Sheet1")
# print(d_)
# *****************************************************************
...
# 1.2.1 查询
# Gw_PO.personalHealthRecord_query(File_PO.jsonfile2dict("./phs/01.json"))
# Gw_PO.personalHealthRecord_query({"姓名": "胡成", "性别": "男", "身份证号": "230202194504020016", "出生日期范围": [[2025,1,1], [2027,3,1]],"人群分类":["残疾人","孕产妇"],"档案是否开放":"否",
...
# 1.2.3 更新 - 居民健康档案
d_idcard = {"身份证号": "110107199001016298"}
Gw_PO.personalHealthRecord_query(d_idcard)
Gw_PO.personalHealthRecord_operation('更新')
Gw_PO.personalHealthRecord_modify(d_idcard, File_PO.jsonfile2dict("./phs/01.json"))
...
# Gw_PO.personalHealthRecord_query({"人群分类":["残疾人", "孕产妇"],"既往史":["脑卒中"],"本人电话":"1382121212"})
# Gw_PO.personalHealthRecord_query({"姓名": "胡成", "性别": "男", "身份证号": "230202194504020016", "出生日期范围": [[2025,1,1], [2027,3,1]],"人群分类":"残疾人","档案是否开放":"否",
#                             "档案状态":"已死亡","血型":"不详","年龄":[1,5],"常住类型":"户籍","是否签约":"是","是否残疾":"否",
#                             "今年是否体检":"否","既往史":"脑卒中","今年体检日期":[[2025,2,1], [2027,4,1]],"今年是否已更新":"是",
#                             "今年更新日期":[[2025,5,1], [2027,5,5]],"医疗费用支付方式":"全公费","建档日期":[[2025,6,1], [2027,7,5]],"档案缺失项目":"性别","建档人":"ceshi",
