...
Web_PO.opnLabel(d_menu_basicPHS['体检登记'])
Web_PO.swhLabel(1)


# todo 1 查询
Gw_PO.phs_healthExamination_tjregister_query({'建档日期': [[2025,1,13],[2025,2,12]]})
# Gw_PO.phs_healthExamination_tjregister_query({"管理机构": "招远市卫健局", '是否仅查询机构': '是', "档案状态": "在档", "姓名": "胡成", "身份证号": "110101195901015999",
#     '出生日期': [[2025,1,1],[2025,2,2]], '建档日期': [[2025,1,13],[2025,2,12]],
#     "现住址": ["泉山街道", "花园社区居民委员会", "123"], "人群分类" : ['老年人', '一般人群']})



# todo 2 操作 - 新增 (国家基本公共卫生服务项目健康体检表)
Gw_PO.phs_healthExamination_tjregister_operation({'operate': '新增', 'option': {"身份证号": "110101199001015000"}})
Gw_PO.phs_healthExamination_tjregister_operation({'operate': '新增', 'data': {
