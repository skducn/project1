...
# 动态调用函数1
# s_func = 'phs_healthrecord_exit_query'
# getattr(Gw_PO, s_func)({"身份证号": "41052220000511081"})
# 动态调用函数2(有风险)
# s_func = 'Gw_PO.phs_healthrecord_exit_query({"身份证号": "41052220000511081"})'
# eval(s_func)
# *****************************************************************
from GwPO import *
...
varUrl = d_menu_basicPHS['迁出审核']
s_func = varUrl.split('http://192.168.0.203:30080/')[1]
s_func = s_func.replace("/", "_")
s_func = s_func.lower()
# print(s_func)  # phs_healthrecord_exit
Web_PO.opnLabel(d_menu_basicPHS['迁出审核'])
Web_PO.swhLabel(1)



# todo 1 查询
# Gw_PO.phs_healthrecord_exit_query()
# getattr(Gw_PO, s_func + '_query')({"姓名": "李明明", "身份证号": "110101195901018874", "申请日期": [[2025, 1, 1], [2025, 1, 2]], "管理机构": ["招远市卫健局"], "申请人": "test", "状态": "已批准"})
