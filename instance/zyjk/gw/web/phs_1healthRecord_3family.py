...
varUrl = d_menu_basicPHS['家庭健康档案']
# s_func = varUrl.split('http://192.168.0.203:30080/')[1]
# s_func = s_func.replace("/", "_")
# s_func = s_func.lower()
# print(s_func)  # phs_healthrecord_family
Web_PO.opnLabel(d_menu_basicPHS['家庭健康档案'])
Web_PO.swhLabel(1)


# todo 1 查询
Gw_PO.phs_healthrecord_family_query({"身份证号": "110118199001019375"})
# getattr(Gw_PO, s_func + '_query')({"身份证号": "110107199001016298"})
# getattr(Gw_PO, s_func + '_query')({"姓名": "胡成", "身份证号": "230202194504020016", "现住址": "上海东方路1000号", "家庭住址": ["海阳市", "东村街道", "和平村委会"], "管理机构": "招远市卫健局"})


# # todo 2 更新（点击姓名）
# Gw_PO.phs_healthrecord_family_operation()
# getattr(Gw_PO, s_func + '_operation')("姓名")

# todo 维护家庭成员
Gw_PO.phs_healthrecord_family_operation("维护家庭成员")
Gw_PO.phs_healthrecord_family_modify([{"姓名": "胡成", "户主姓名": "zhangsan", "户主身份证号": "3101011980012343", "与户主关系": "户主"}])
# getattr(Gw_PO, s_func + '_operation')("维护家庭成员")
# getattr(Gw_PO, s_func + '_modify')([{"姓名": "陈蒙", "户主姓名": "zhangsan", "户主身份证号": "3101011980012343", "与户主关系": "子"}])
...
# todo 2 导出
# Gw_PO.phs_healthrecord_family_export()
# getattr(Gw_PO, s_func + '_export')("/Users/linghuchong/Desktop/17456")
