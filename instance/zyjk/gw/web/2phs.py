...
varUrl = Gw_PO.personalHealthRecord_s({"身份证号": "230202194504020016"})

# 1.2.2 获取居民健康档案
# Gw_PO.personalHealthRecord_info(varUrl)
# d_info = Gw_PO.personalHealthRecord_info('http://192.168.0.203:30080/phs/personalAddOrUpdate/addOrUpdate/530?id=530&type=1')
# print(d_info)

# 1.2.3 更新居民健康档案
Gw_PO.personalHealthRecord_update({" 性别 ": "女", " 民族 ": "回族", " 文化程度 ": "专科教育", " 职业 ": "军人", " 婚姻状况 ": "离婚", " 档案是否开放 ": "否",
                                   ' 姓名 ': "李四", ' 本人电话 ': "13815161718", ' 联系人姓名 ': "令狐冲", ' 联系人电话 ': "58771234", ' 工作单位 ': "上海智赢", ' 更新内容 ': "测试三峡",
