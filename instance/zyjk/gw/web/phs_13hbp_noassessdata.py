...
# 动态调用函数1
# s_func = 'phs_hbp_noassessdata_query'
# getattr(Gw_PO, s_func)({"身份证号": "41052220000511081"})
# 动态调用函数2(有风险)
# s_func = 'Gw_PO.phs_hbp_noassessdata_query({"身份证号": "41052220000511081"})'
# eval(s_func)
# *****************************************************************
from GwPO import *
...
varUrl = d_menu_basicPHS['本年度未评']
s_func = varUrl.split('http://192.168.0.203:30080/')[1]
s_func = s_func.replace("/", "_")
s_func = s_func.lower()
# print(s_func)  # phs_hbp_noassessdata
Web_PO.opnLabel(d_menu_basicPHS['本年度未评'])
Web_PO.swhLabel(1)



# todo 1 查询
# Gw_PO.phs_hbp_noassessdata_query()
s_qty = getattr(Gw_PO, s_func + '_query')({"身份证号":"110101199001012256", "人群分类": ["残疾人", "儿童"]})
# s_qty = getattr(Gw_PO, s_func + '_query')({"管理机构":["玲珑卫生院", "玲珑镇大蒋家村卫生室"], "档案状态": "在档", "姓名": "刘长春", "身份证号":"110101199001012256",
