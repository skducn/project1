...
# # todo 3 详情 - 编辑（糖尿病随访记录）
# Gw_PO.phs_diabetes_tnbjob_query({"身份证号": "370685202402190640"})
# Gw_PO.phs_diabetes_tnbjob_operation({'operate': '详情', 'option': {'随访日期': '2025-02-02'}})
# Gw_PO.phs_diabetes_tnbjob_operation({'operate': '详情', 'index': {'随访日期': '2025-02-09', 'operate2': '编辑'},
#                                        'value': {'随访日期': [2025, 2, 11], '随访方式': '网络', '症状': ['头痛头晕', {'其他': '123'}, '下肢水肿'],
...
# todo 4-3 编辑 - 新增(糖尿病随访记录)
# Gw_PO.phs_diabetes_tnbjob_query({"身份证号": "370685202402190640"})
# Gw_PO.phs_diabetes_tnbjob_operation({'operate': '编辑', 'option': {'随访日期': '2025-02-09'}})
# Gw_PO.phs_diabetes_tnbjob_operation({'operate': '编辑', 'index': {'随访日期': '2025-02-09', 'operate2': '编辑或新增'},
#                                        'value': {'随访日期': [2025, 2, 13], '随访方式': '网络', '症状': ['头痛头晕', {'其他': '123'}, '下肢水肿'],
#                                        '血压': [11, 12], '身高': '177', '体重': [66, 77], '足背动脉搏动':'未检测', '其他': "测试一下",
#                                        '日吸烟量':[11,14], '日饮酒量':[112,144],
#                                        '运动频率实际': '每天', '运动频率目标': '不运动',
#                                        '运动时长':[11, 23],
...
#                                        '用药调整意见药物名称3':'阿莫西林钠/克拉维酸钾', '用药调整意见用法用量3每日':'一次性', '用药调整意见用法用量3每次':'6',
#                                        '转诊原因':'123', '转入医疗机构及科室':'456', '联系人':'789', '联系人电话':'1000', '结果':'到位', '备注':'nonono',
#                                        '下次随访日期': [2025, 4, 9], '随访医生':'测试1', '居民签字': '张三丰'}})


# # todo 4.2 编辑 - 引用上次新增(糖尿病随访记录)
# Gw_PO.phs_diabetes_tnbjob_query({"身份证号": "370685202402190640"})
# Gw_PO.phs_diabetes_tnbjob_operation({'operate': '编辑', 'option': {'随访日期': '2025-02-09'}})
# Gw_PO.phs_diabetes_tnbjob_operation({'operate': '编辑', 'index': {'operate2': '引入上次新增'},
...
# # todo 5 删除
Gw_PO.phs_diabetes_tnbjob_query({"身份证号": "370685202402190640"})
Gw_PO.phs_diabetes_tnbjob_operation({'operate': '删除', 'option': {'随访日期': '2025-02-09'}})
