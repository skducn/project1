...
# 动态调用函数1
# s_func = 'phs_healthrecord_regionalfile_query'
# getattr(Gw_PO, s_func)({"身份证号": "41052220000511081"})
# 动态调用函数2(有风险)
# s_func = 'Gw_PO.phs_healthrecord_regionalfile_query({"身份证号": "41052220000511081"})'
# eval(s_func)
# *****************************************************************
from GwPO import *
...
varUrl = d_menu_basicPHS['区域档案查询']
s_func = varUrl.split('http://192.168.0.203:30080/')[1]
s_func = s_func.replace("/", "_")
s_func = s_func.lower()
# print(s_func)  # phs_healthrecord_regionalfile
Web_PO.opnLabel(d_menu_basicPHS['区域档案查询'])
Web_PO.swhLabel(1)


# todo 1 查询
# Gw_PO.phs_healthrecord_regionalfile_query()
