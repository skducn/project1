...
# print('基本公卫 =>', d_menu_basicPHS)
# Gw_PO.logger.info(d_menu_basicPHS)
...
# 1 查询
# Gw_PO.healthEducationActivity_query({"活动日期":[[2025,1,2], [2025,2,4]], "活动地点": "上海", "活动形式": "开展咨询活动", "活动主题": "普法宣传", "主讲人": "阿依达"})
