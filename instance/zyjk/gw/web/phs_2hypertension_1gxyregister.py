...
# Gw_PO.phs_hypertension_gxyregister_operation([{' 管理级别 ': "二级", ' 是否终止管理 ': '是'}, '编辑'])
Gw_PO.phs_hypertension_gxyregister_operation([{' 是否终止管理 ': '否', ' 终止管理日期 ': [2025, 2, 5], ' 终止管理原因 ': "nono",
                                               ' 建卡时间 ': [2025, 2, 2], ' 建卡医生 ':"卫生院", ' 建卡医疗机构 ': "待定机构",
                                               }, '编辑'])
# Gw_PO.phs_hypertension_gxyregister_operation([{' 居住住址 ': ['上海市', '市辖区', '虹口区', '广中路街道', '商业一村居委会', '多媒体100号'],
#                                                ' 确诊日期 ': [2024, 7, 1], ' 管理级别 ': "二级",
#                                                ' 是否终止管理 ': '否', ' 终止管理日期 ': [2025, 2, 5], ' 终止管理原因 ': "nono",
#                                                ' 建卡时间 ': [2025, 2, 2], ' 建卡医生 ':"卫生院", ' 建卡医疗机构 ': "待定机构"}, '编辑'])
...
#                                                ' 危险因素 ':['男性>55 岁或女性>65 岁', '以静息为主的生活方式']}, '新增'])
...
#                                                ' 高血压分级 ': '二级高血压', ' 危险分层 ': '高危层', ' 评估日期 ': [2025, 2, 3]}, '新增'])

# Gw_PO.phs_hypertension_gxyregister_operation([{' 高血压分级 ': '二级高血压', ' 危险分层 ': '高危层', ' 评估日期 ': [2025, 2, 3]}, '新增'])
