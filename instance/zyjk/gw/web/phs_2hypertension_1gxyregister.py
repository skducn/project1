...
# Gw_PO.phs_hypertension_gxyregister_operation({'operate': '详情', 'index': {'operate2': '编辑'},
...
# Gw_PO.phs_hypertension_gxyregister_operation({'operate': '评估', 'index': {'operate2': '新增'},
#                                                'value': {' 血压 ': [11, 12], ' 身高(cm) ': "177", ' 体重(kg) ': "55",
...
# Gw_PO.phs_hypertension_gxyregister_operation({'operate': '随访', 'index': {'operate2': '新增'},
#                                               'value': {'随访日期': [2025, 3, 9], '随访方式': '网络', '症状': ['头痛头晕', {'其他': '123'}, '下肢水肿'],
...
# # todo 5.2 随访 - 引入上次新增(高血压随访记录)
# Gw_PO.phs_hypertension_gxyregister_operation({'operate': '随访', 'option': {'建卡日期': '2025-01-14'}})
# Gw_PO.phs_hypertension_gxyregister_operation({'operate': '随访', 'index': {'operate2': '引入上次新增'},
#                                           "value": {'随访日期': [2025, 2, 9], '下次随访日期': [2025, 5, 9]}})
