...
# 动态调用函数1
# s_func = 'phs_hypertension_gxyregister_query'
# getattr(Gw_PO, s_func)({"身份证号": "41052220000511081"})
# 动态调用函数2(有风险)
# s_func = 'Gw_PO.phs_hypertension_gxyregister_query({"身份证号": "41052220000511081"})'
# eval(s_func)
# *****************************************************************
from GwPO import *
...
varUrl = d_menu_basicPHS['高血压专项']
# s_func = varUrl.split('http://192.168.0.203:30080/')[1]
# s_func = s_func.replace("/", "_")
# s_func = s_func.lower()
# print(s_func)  # phs_hypertension_gxyregister
Web_PO.opnLabel(d_menu_basicPHS['高血压专项'])
Web_PO.swhLabel(1)
...
# getattr(Gw_PO, s_func + '_query')({"身份证号": "110101199001012256"})
...
# todo 3 详情
Gw_PO.phs_hypertension_gxyregister_operation({'operate': '详情', 'option': {'随访日期': '2024-07-09'}})

# Gw_PO.phs_hypertension_gxyregister_operation({'operate': '详情', 'option': {'随访日期': '2025-02-14'}, 'index': {'operate2': '编辑'},
# #                                          "value": {' 是否终止管理 ': '否', ' 终止管理日期 ': [2025, 2, 5], ' 终止管理原因 ': "nono",
...
# todo 4 评估
# Gw_PO.phs_hypertension_gxyregister_operation([{'建卡日期': '2024-07-09', '年龄': "35"}, '评估'])
# Gw_PO.phs_hypertension_gxyregister_operation([{' 血压 ': [11, 12], ' 身高(cm) ': "177", ' 体重(kg) ':'55',
#                                                ' 危险因素 ':['男性>55 岁或女性>65 岁', '以静息为主的生活方式']}, '评估新增'])
...
#                                                ' 高血压分级 ': '二级高血压', ' 危险分层 ': '高危层', ' 评估日期 ': [2025, 2, 3]}, '评估新增'])

# Gw_PO.phs_hypertension_gxyregister_operation([{' 高血压分级 ': '二级高血压', ' 危险分层 ': '高危层', ' 评估日期 ': [2025, 2, 3]}, '评估新增'])
...
Gw_PO.phs_hypertension_gxyregister_operation([{'随访日期': [2025, 2, 9], '随访方式': '网络', '症状': ['头痛头晕', {'其他': '123'}, '下肢水肿'],
                                               ...
                                               '下次随访日期': [2025, 5, 9], '随访医生':'测试1', '居民签字': '张三丰'}, '随访新增'])
#
