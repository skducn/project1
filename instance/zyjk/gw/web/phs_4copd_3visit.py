...
# todo 2 导出(17.xls)
Gw_PO.phs_copd_visit_export("/Users/linghuchong/Desktop/44")



# todo 3 详情
Gw_PO.phs_copd_visit_operation([{'身份证': '340203202407016690'}, '详情'])
Gw_PO.phs_copd_visit_operation([{'身份证': '340203202407016690'}, '编辑'])
# Gw_PO.phs_copd_visit_operation([{' 管理级别 ': "二级", ' 是否终止管理 ': '是'}, '详情编辑'])
# Gw_PO.phs_copd_visit_operation([{' 是否终止管理 ': '否', ' 终止管理日期 ': [2025, 2, 5], ' 终止管理原因 ': "nono",
#                                                ' 建卡时间 ': [2025, 2, 2], ' 建卡医生 ':"卫生院", ' 建卡医疗机构 ': "待定机构",
#                                                }, '详情编辑'])
# Gw_PO.phs_copd_visit_operation([{' 居住住址 ': ['上海市', '市辖区', '虹口区', '广中路街道', '商业一村居委会', '多媒体100号'],
