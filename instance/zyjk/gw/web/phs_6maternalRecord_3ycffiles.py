...
# Gw_PO.phs_maternalRecord_ycffiles_operation({'operate': '健康检查记录', 'title': '第2～5次产前随访服务记录表', 'data': {}})
# Gw_PO.phs_maternalRecord_ycffiles_operation({'operate': '健康检查记录', 'title': '产后访视记录表', 'data': {}})
# Gw_PO.phs_maternalRecord_ycffiles_operation({'operate': '健康检查记录', 'title': '产后42天健康检查记录表', 'data': {}})


# # 新增登记及第一次产前随访
# Gw_PO.phs_maternalRecord_ycffiles_operation({'operate': '健康检查记录', 'data': {
#     '填表日期': [2024, 1, 1], '是否高危产妇': '是', '丈夫姓名': '阿依达', '丈夫年龄': '43', '丈夫电话': '13611223344',
#     '孕次': '1', '产次': ['2', '3'], '末次月经': [2024, 2, 2], '孕周': ['4', '5'], '预产期': [2024, 3, 3],
#     '既往史': ['心脏病', {'其他': '1231'}],
#     '家族史': ['精神病史', {'其他': '456'}], '妇科手术史': {'有': '234234'},
