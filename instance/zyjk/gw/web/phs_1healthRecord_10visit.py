...
# 动态调用函数1
# s_func = 'phs_healthrecord_visit_query'
# getattr(Gw_PO, s_func)({"身份证号": "41052220000511081"})
# 动态调用函数2(有风险)
# s_func = 'Gw_PO.phs_healthrecord_visit_query({"身份证号": "41052220000511081"})'
# eval(s_func)
# *****************************************************************
from GwPO import *
...
s_func = s_func.lower()
# print(s_func)  # phs_healthrecord_visit
Web_PO.opnLabel(d_menu_basicPHS['就诊管理'])
Web_PO.swhLabel(1)


# todo 1 查询
# Gw_PO.phs_healthrecord_visit_query()
...
# # todo 2 导出(17.xls)
# # Gw_PO.phs_healthrecord_visit_export()
