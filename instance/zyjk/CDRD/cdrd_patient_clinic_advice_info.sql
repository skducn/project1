...
BEGIN
    ...
    -- 获取就诊表中门诊记录数量
    select @result = count(*) from a_cdrd_patient_visit_info where patient_visit_type_key=1;
    ...
    BEGIN
        ...
        BEGIN
            ...
            FROM (
                ...
                FROM a_cdrd_patient_visit_info where patient_visit_type_key=1
            ) AS subquery
            ...
            VALUES (
                ...
                @patient_visit_in_time, -- 开放时间, 同就诊日期
