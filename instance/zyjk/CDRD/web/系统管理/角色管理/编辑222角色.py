...
# 生成默认数据
test_data = Fake_PO.genTest(['genAddress'], 1)
print(f"编辑222角色，生成随机数据: {test_data}")
...
def run_playwright():
    ...
    with sync_playwright() as p:
        ...
        page.get_by_placeholder("请输入姓名").fill("222")
        page.get_by_role("button", name="查询").click()
        page.get_by_role("button", name="编辑").first.click()
        page.get_by_placeholder("请输入内容").click()
        page.get_by_placeholder("请输入内容").fill(test_data[0][0])
