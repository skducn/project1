...
def run_playwright():
    ...
    with sync_playwright() as p:
        ...
        page.get_by_placeholder("请输入权限字符").fill(test_data[0][1])
        page.get_by_label("角色顺序").click()
        page.get_by_label("角色顺序").fill(test_data[0][2])
        ...
        page.get_by_placeholder("请输入内容").fill(test_data[0][3])
    ...
    return {
        ...
        "role_key": test_data[0][1],
        "role_sort": test_data[0][2],
        "remark": test_data[0][3]
    }
