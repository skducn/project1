...
# Cdrd_PO.subProcedure("p_gen_names", "姓名")
...
# Cdrd_PO.subProcedure("p_trueFalse", "{'0': '是', '1': '否'}")
...
# Cdrd_PO.procedure("cdrd_patient_diag_info", '诊断表', 10)
...
# Cdrd_PO.procedure("sys_user", '用户表', 1)
...
# exec a_sys_role_menu @roleName=副主任, @menu_id=18;
# exec a_sys_role_menu @roleName=副主任, @menu_id=20;
# exec a_sys_role_menu @roleName=副主任, @menu_id=21;
...
# exec a_sys_menu @menuType=M, @menuName=系统管理, @menuParentName=None;
# exec a_sys_menu @menuType=M, @menuName=系统监控, @menuParentName=None;
