...
('初诊', '原发性高血压','I10')'''
    ...
    def _ab_visitDiagnosis(self, varCommon):
        ...
        Sqlserver_PO.crtTableByCover('ab_visitDiagnosis',
                                     ...
                                     n_value NVARCHAR(100)
                                     ''')
        Sqlserver_PO.execute("""INSERT INTO ab_visitDiagnosis (n_value) VALUES 
('就诊 100'),
('就诊 101'),
('就诊 102'),
('就诊 103'),
...
""")
    ...
    def _ab_symptom(self, varCommon):
        ...
        Sqlserver_PO.crtTableByCover('ab_symptom',
                                     ...
                                     desc1 NVARCHAR(1000)
                                     ''')
        Sqlserver_PO.execute("""INSERT INTO ab_symptom (name,code,desc1) VALUES 
('头晕', 'S001', '间歇性头晕伴乏力'),
('胸闷', 'S201', '胸骨后压迫感，活动后加重'),
('呼吸困难', 'S402', '夜间平卧时呼吸困难'),
('言语不清', 'S302', '表达困难或言语含糊'),
('头晕', 'S001', '间歇性头晕伴乏力'),
('口渴', 'S102', '持续性口渴，饮水量增加'),
