...
BEGIN
    ...
    SELECT
        ...
        CASE WHEN patient_visit_type_key = '2' THEN '3500.55' ELSE '400.1234' END AS patient_case_in_total_cost,
        CASE WHEN patient_visit_type_key = '2' THEN '630.66' ELSE '600.12345678' END AS patient_case_in_selfpay_cost,
