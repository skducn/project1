...
CREATE OR ALTER PROCEDURE s_cdrd_patient_visit_info_5
...
BEGIN
    ...
    BEGIN TRY
        ...
        ;WITH PatientSequences AS (
            ...
            FROM (SELECT TOP (@PatientCount) patient_id FROM CDRD_PATIENT_INFO_5 WHERE patient_id IS NOT NULL) p
            CROSS JOIN (
        ...
        --4. 数据插入
        INSERT INTO CDRD_PATIENT_VISIT_INFO_5 (
