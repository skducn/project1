...
CREATE OR ALTER PROCEDURE cdrd_patient_visit_info__data
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            VALUES (
                ...
                '23', -- 就诊年龄（岁）
                RIGHT('0000000' + CONVERT(NVARCHAR(10), ABS(CHECKSUM(NEWID())) % 10000000), 7), -- 就诊科室编码
                '就诊科室', -- 就诊科室
                '入院病房', -- 入院病房
