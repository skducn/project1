...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            -- 出院记录类型
            DECLARE @RandomHospitalTypeIdKey NVARCHAR(100)
            DECLARE @RandomHospitalTypeIdValue NVARCHAR(100)
            SELECT TOP 1 @RandomHospitalTypeIdKey=n_key, @RandomHospitalTypeIdValue=n_value FROM ab_dischargeRecordType ORDER BY NEWID()
