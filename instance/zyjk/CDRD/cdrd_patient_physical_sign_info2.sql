...
-- 数据量：每名患者5条（共15万）
-- 优化目标：提升性能，避免嵌套循环
-- 原耗时: 1836.6717 秒 → 优化后预计耗时: 0.5~1 秒
    ...
    BEGIN TRY
        ...
        RandomFields AS (
            SELECT *,
                   ...
                   ps.type_key AS sign_type_key, ps.type_value AS sign_type_value,
                   pu.unit_key AS sign_unit_key, pu.unit_value AS sign_unit_value
        ...
        INSERT INTO a_cdrd_patient_physical_sign_info (
            patient_id,
            patient_visit_id,
