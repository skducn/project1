...
# Description: 盛蕴ERP管理平台(测试环境) , 基础服务 - 主数据管理
...
# 1 查询
# d_= Erp_PO.hospital_search({"医院编码": "HCO00002842", "医院名称": "六院东分地址", "别名":"6分院", "医院级别": "一级医院",
#                         "省份": "上海", "城市": "上海市", "区县": "浦东新区", "启用状态": "启用",
#                         "最后更新时间": [2024, 12, 6, 2024, 12, 29]})
# print(d_)  # {'id': 'HCO00002842', 'qty': 1}

# 2 新增(依赖于查询)
# d_ = Erp_PO.hospital_search({"医院编码": "HCO000028222"})
# print(d_) # {'id': None, 'qty': None}
# Erp_PO.hospital_add(d_['qty'], {"医院全称": "上海自动化医院", "医院简称": "上自院", "医院类型": "分院", "医院级别": "民营",
...
# 3 修改(依赖于查询)
# d_ = Erp_PO.hospital_search({"医院编码": "HCO00002842"})
# print(d_)  # {'id': 'HCO00002842', 'qty': 1}
# Erp_PO.hospital_edit(d_['qty'],
#                      {"医院全称": "天津自动化医院1", "医院简称": "天自院1", "医院级别": "二级医院",
#                       "省份": "天津", "启用状态": "启用", "城市": "天津市", "区县": "南开区", "详细地址": "天津市南开区卫津路94号",
#                       "获取方式": "手动输入", "经度坐标":"111", "纬度坐标":"333", "邮政编码": "300392", "电话": "022-23729426", "邮箱": "nk@163.com", "网址": "http://www.nk.com", "床位数": "50", "门诊量": "20000",
#                       "备注信息": "自动化测试用，请勿删除1"})  # 获取方式：自动获取，手动输入

# 4 详情(依赖于查询)
# d_ = Erp_PO.hospital_search({"医院编码": "HCO00002842"})
# print(d_)  # {'id': 'HCO00002842', 'qty': 1}
# Erp_PO.hospital_info(d_['qty'])
#
...
#***************************************************************
# todo 社区卫生服务中心管理 （查询界面字段与列表字段不匹配） 没做

# Erp_PO.newLabel(d_menu_url["社区卫生服务中心管理"], 1)
# # 1 查询
# d_ = Erp_PO.community_search({"医院编码": "HCO00002842", "医院名称": "六院东分地址", "别名": "六东分", "省份": "上海",
#                          "城市": "上海市", "区县": "浦东新区", "所属中心": "周浦", "启用状态": "启用",
#                         "最后更新时间": [2024,5,6, 2024,6,7]})
# print(d_)  # {'id': 'HCO00002842', 'qty': 1}
...
# 1 查询
# d_ = Erp_PO.dealer_search({"经销商名称": "百慕大自动优质经销商", "经销商级别": "二级",
#                         "省份": "上海", "城市": "上海市", "区县": "浦东新区", "启用状态": "启用",
#                         "最后更新时间": [2024, 12, 6, 2024, 12, 29]})
# print(d_)  # {'id': 'HCO00002842', 'qty': 1}

# 2 新增(依赖于查询)
# d_ = Erp_PO.dealer_search({"经销商名称": "百慕大自动优质经销商3434"})
# print(d_) # {'id': None, 'qty': None}
# Erp_PO.dealer_add(d_['qty'], {"经销商名称": "百慕大自动优质经销商",
#                      "省份": "上海", "城市": "上海市", "区县": "浦东新区", "详细地址": "上海浦东南路1000号", "联系电话": "021-58776522",
#                      "启用状态": "启用", "经销商级别": "一级",
#                      "备注信息": "测试一下"})

# 3 修改(依赖于查询)
# d_ = Erp_PO.dealer_search({"经销商名称": "百慕大自动优质经销商"})
# print(d_)  # {'id': 'HCO00002842', 'qty': 1}
# Erp_PO.dealer_edit(d_['qty'],
#                    {"经销商名称": "百慕大自动优质经销商1",
...
# 1 查询
# d_ = Erp_PO.business_search({"商业公司编码": "COM00004", "商业公司名称": "阿依达商业自动化有限公司", "联系人": "张三",
#                         "启用状态": "启用", "最后更新时间": [2025,1,1, 2025, 1,4]})
# print(d_)  # {'id': 'COM00004', 'qty': 1}

# 2 新增(依赖于查询)
# 联系人电话 无法填写固定电话
d_ = Erp_PO.business_search({"商业公司编码": "COM0000434"})
print(d_)  # {'id': None, 'qty': None}
# Erp_PO.business_add(d_['qty'], {"商业公司全称": "阿依达商业自动化有限公司", "商业公司简称": "ayt自动化", "商业公司地址": "上海东方路100号", "联系人": "张三", "联系人电话": "13816109040",
...
# 3 修改(依赖于查询)
# d_ = Erp_PO.business_search({"商业公司编码": "COM00004"})
# print(d_)  # {'id': 'COM00004', 'qty': 1}
# Erp_PO.business_edit(d_['qty'],
...
d_ = Erp_PO.business_search({"商业公司编码": "COM00004"})
print(d_)  # {'id': 'COM00004', 'qty': 1}
Erp_PO.business_info(d_['qty'])


# 5 列表字段设置
# Erp_PO.business_setup(3, {"商业公司编码": "否", "启用状态": "是"})
