...
# # todo 产品开发
ErpApp_PO.Web_PO.scrollToBottom()
# ErpApp_PO.product({新增产品开发}, {拜访人}, {开发跟进})
ErpApp_PO.product({"开发医院类型": "站点", "开发医院信息": "曹路社区", "开发产品名称": "依叶", "开发负责人1": "薛伟", "开发负责人2": "陈东升",
                   "药事会计划开始日期": [2025, 10, 9], "药事会计划结束日期": [2025, 11, 11], "提单科室": "呼吸科"},

                  {"搜索": "崇中心", "科室主任": {"陈海群": "中立"}, "药剂科主任": {"杨忠英": "中立"}, "医务处长": {"萧屹": "反对"}, "业务院长": {"吴凤灵": "中立"}, "院长": {"王丽红": "中立"},
                   "其他药事会成员": {"唐晓晶": "支持", "刘月月": "反对", "李剑": "中立"}},

                  {"搜索": "曹路社区", "开发次数": "二次开发", "提单科室": "神外", "提单规则": "可随时提单", "过会规则": ["临床主任确认即可过会", "需投票，过三分之二票数"],
                   "提单状态": "可随时提单，已承诺", "药剂科会前确认信息": "已收到报告，确认上会",
                   "药事会计划开始日期": [2025, 7, 10], "药事会计划结束日期": [2025, 11, 10], "药事会实际召开时间": [2022, 1, 1, 1, 1],
                   "会前评估能否过会": "否", "经改进后能否过会": "是", "过会日期": [2020, 1, 1]}
                  )
# ErpApp_PO.Web_PO.scrollToBottom(5)
#
# # todo 审批中心
