...
# 1.2 获取未审批列表页数据，筛选条件
# d_data = ErpApp_PO.get_approve_list({"标签": "未审批", "筛选": {"审批类型": None, "审批状态": "未审批"}})
# d_data = ErpApp_PO.get_approve_list({"标签": "未审批", "筛选": {"审批类型": None, "审批状态": "待二级审批"}})
# print(d_data)
...
# 2.2 获取已审批列表页数据，筛选条件
# d_data = ErpApp_PO.get_approve_list({"标签": "已审批", "筛选": {"审批类型": None, "审批状态": "已通过"}})
# d_data = ErpApp_PO.get_approve_list({"标签": "已审批", "筛选": {"审批类型": ["新增客户", "新增潜力"], "审批状态": "已通过"}})
# print(d_data)
