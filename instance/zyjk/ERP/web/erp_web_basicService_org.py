...
# 1 查询
d_ = Erp_PO.staff_search({"联系方式": "17710909010", "职位": "推广代表", "是否在职": "在职",
                        "入职日期": [2025, 1, 1, 2025, 1, 11], "主管信息": "朱燕", "启用状态": "启用",
...
#                    "邮箱": "ti@163.com","职称": "推广代表", "是否在职": "在职", "入职日期": "2025-01-08", "主管信息": "朱燕",
#                      "启用状态": "启用", "备注信息": "测试二下"})

# 3 修改(依赖于查询)
# d_ = Erp_PO.staff_search({"联系方式": "13611990909"})
# print(d_)  # {'id': '100076', 'qty': 1}
# Erp_PO.staff_edit(d_['qty'], {"员工姓名": "提2", "省份": "天津", "城市": "天津市", "性别": "女", "联系方式": "13611990909", "邮箱": "gege@263.com",
#                     "职称": "财务总监", "是否在职": "离职", "入职日期": [2025, 2, 5], "离职日期": [2025, 4, 9], "启用状态": "停用", "备注信息": "测试一下123"})
