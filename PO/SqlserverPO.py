...
3.7 自动添加一条记录 genRecord()
3.8 自动生成必填项记录 genRecordByNotNull(self, varTable)
...
class SqlServerPO:
    ...
    def setFieldComment(self, varTable, varField, varComment, isDrop=False):
        ...
        # setFieldComment('t_user','ID','编号', True) 删除字段注释
