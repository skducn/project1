...
class ConfigparserPO2:
    ...
    def DB_MYSQL(self, name):
        value = self.cf.get("DB_MYSQL", name)
        return value
...
if __name__ == '__main__':
    ...
    Configparser_PO = ConfigparserPO2('config2.ini')
    ...
    if 'section' not in sectionName:
        ...
        Configparser_PO.cf.write(open('config2.ini', 'w'))  # 写保存
