...
from erp.ConfigparserPO2 import *
Configparser_PO = ConfigparserPO2('./erp/config2.ini')

from PO.MysqlPO import *
Mysql_PO = MysqlPO(Configparser_PO.DB_MYSQL("host"), Configparser_PO.DB_MYSQL("user"), Configparser_PO.DB_MYSQL("password"), Configparser_PO.DB_MYSQL("database"), Configparser_PO.DB_MYSQL("port"))
